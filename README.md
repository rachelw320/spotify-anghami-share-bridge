...
The steps for both shortcuts (send to anghami and send to spotify) are in [shortcuts/README.md](shortcuts/README.md). The last step in each one opens a whatsapp link like wa.me/447XXXXXXXXX?text={message}.
